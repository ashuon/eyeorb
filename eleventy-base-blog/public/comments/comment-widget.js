...
const s_formId = '1FAIpQLSeQOGH2JZwokHbmW9fHvdXnS4UPrunTKyDUMZi2BznqaVMTUg';
const s_nameId = '902825084';
const s_websiteId = '532129405';
const s_textId = '1608145450';
...
function createComment(data) {
    ...
    if(data.Admin == true) {
        name.insertAdjacentHTML('beforeend', " <img src='/comments/endsky_blink.gif' style='width:15px; height:15px' title='admin (eyeorb)' alt='admin'> ");
        } 
